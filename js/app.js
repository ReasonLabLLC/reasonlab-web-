...
/* ==========================================================
   REASONLAB
   Save Business Analyzer → Autofill Booking Page
   ========================================================== */

(function () {

    // ---------- SAVE DATA FROM ANALYZER ----------
    ...
    // Save before going to booking page
    ...
    if (industryField && !industryField.value)
        industryField.value = data.industry;
